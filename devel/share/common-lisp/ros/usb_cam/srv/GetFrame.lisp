...
(cl:defmethod cl:initialize-instance :after ((m <GetFrame-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetFrame-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name usb_cam-srv:<GetFrame-request> is deprecated: use usb_cam-srv:GetFrame-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetFrame-request>)))
  ...
  "6897ffa073f098e62edfad95fcecacba")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetFrame-request)))
  "Returns md5sum for a message object of type 'GetFrame-request"
  "6897ffa073f098e62edfad95fcecacba")
...
(cl:defmethod cl:initialize-instance :after ((m <GetFrame-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetFrame-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name usb_cam-srv:<GetFrame-response> is deprecated: use usb_cam-srv:GetFrame-response instead.")))

(cl:ensure-generic-function 'frame-val :lambda-list '(m))
(cl:defmethod frame-val ((m <GetFrame-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usb_cam-srv:frame-val is deprecated.  Use usb_cam-srv:frame instead.")
  (frame m))
